...
class ToolArgument(BaseModel):
    ...
    def _render_dict_type(self) -> dict:
        """
        ...
        return {
            ...
            "properties": {
                # "key": {
                #     "type": self._transform_python_type_to_openai_type(key_type),
                # },
                # "value": {
                #     "type": self._transform_python_type_to_openai_type(value_type),
                # },
            },
